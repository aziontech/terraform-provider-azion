		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.azion_zone.test", "results.domain", "ex1.com"),
					...
					resource.TestCheckResourceAttr("data.azion_zone.test", "results.name", "Hosted Zone criado pela API"),
