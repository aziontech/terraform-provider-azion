...
**IMPORTANT**: Firewall Function Instances is a child resource of `azion_firewall_main_setting`. Documentation and examples MUST include the parent resource creation to show complete context.
...
| Type | Location |
|------|----------|
| Singular Data Source Doc | `docs/data-sources/firewall_function_instance.md` |
| Plural Data Source Doc | `docs/data-sources/firewall_functions_instance.md` |
| Resource Doc | `docs/resources/firewall_functions_instance.md` |
...
| Type | Location |
|------|----------|
| Singular Data Source Example | `examples/data-sources/azion_firewall_function_instance/data-source.tf` |
| Plural Data Source Example | `examples/data-sources/azion_firewall_functions_instance/data-source.tf` |
| Resource Example | `examples/resources/azion_firewall_functions_instance/resource.tf` |
