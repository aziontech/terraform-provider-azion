...
**IMPORTANT**: DNS Records is a child resource of `azion_intelligent_dns_zone`. Documentation and examples MUST include the parent resource creation to show complete context.
...
| Type | Location |
|------|----------|
| Data Source Doc | `docs/data-sources/intelligent_dns_records.md` |
| Resource Doc | `docs/resources/intelligent_dns_record.md` |
...
| Type | Location |
|------|----------|
| Data Source Example | `examples/data-sources/azion_intelligent_dns_records/data-source.tf` |
| Resource Example | `examples/resources/azion_intelligent_dns_record/resource.tf` |
