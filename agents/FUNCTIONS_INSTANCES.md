...
|---------------|-----------|
| Singular Data Source | `internal/data_source_edge_application_edge_function_instance.go` |
| Plural Data Source | `internal/data_source_edge_application_edge_functions_instance.go` |
| Resource | `internal/resource_edge_application_edge_functions_instance.go` |
...
File: `internal/data_source_edge_application_edge_function_instance.go`
...
File: `internal/data_source_edge_application_edge_functions_instance.go`
...
File: `internal/resource_edge_application_edge_functions_instance.go`
...
| Type | Location |
|------|----------|
| Singular Data Source Doc | `docs/data-sources/edge_application_edge_function_instance.md` |
| Plural Data Source Doc | `docs/data-sources/edge_application_edge_functions_instance.md` |
| Resource Doc | `docs/resources/edge_application_edge_functions_instance.md` |
...
| Type | Location |
|------|----------|
| Singular Data Source Example | `examples/data-sources/azion_edge_application_edge_function_instance/data-source.tf` |
| Plural Data Source Example | `examples/data-sources/azion_edge_application_edge_functions_instance/data-source.tf` |
| Resource Example | `examples/resources/azion_edge_application_edge_functions_instance/resource.tf` |
...
|-----------|----------|---------|
| Singular Data Source | `internal/data_source_edge_application_edge_function_instance.go` | Read single instance |
| Plural Data Source | `internal/data_source_edge_application_edge_functions_instance.go` | List instances |
| Resource | `internal/resource_edge_application_edge_functions_instance.go` | CRUD operations |
| Singular Data Source Doc | `docs/data-sources/edge_application_edge_function_instance.md` | Documentation |
| Plural Data Source Doc | `docs/data-sources/edge_application_edge_functions_instance.md` | Documentation |
| Resource Doc | `docs/resources/edge_application_edge_functions_instance.md` | Documentation |
| Singular Example | `examples/data-sources/azion_edge_application_edge_function_instance/data-source.tf` | Example usage |
| Plural Example | `examples/data-sources/azion_edge_application_edge_functions_instance/data-source.tf` | Example usage |
| Resource Example | `examples/resources/azion_edge_application_edge_functions_instance/resource.tf` | Example usage |
